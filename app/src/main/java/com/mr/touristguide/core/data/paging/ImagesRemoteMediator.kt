...
class ImagesRemoteMediator(
    ...
    private val unsplashImageDao = imageDatabase.imageDao()
    private val unsplashRemoteKeysDao = imageDatabase.remoteKeysDao()
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val response = imagesApi.getAllImages(page = currentPage, perPage = 10)
            ...
            imageDatabase.withTransaction {
                ...
                unsplashRemoteKeysDao.addRemoteKeys(remoteKeys = keys)
